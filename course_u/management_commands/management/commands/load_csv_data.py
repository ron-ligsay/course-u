...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        csv_table_mapping = {
            ...
            # },
            # base_dir + '\\static\\csv\\assessment_test_skill.csv': {
            ...
            # },
            # base_dir + '\\static\\csv\\acad_studentgrades.csv': {
            #     'table_name': 'acad_studentgrades',
            #     'model_name': 'StudentGrades',
            #     'columns':  ["id","grade","student_id","subject_id"],
            #     'attributes' : ["INT PRIMARY KEY NOT NULL AUTO_INCREMENT","FLOAT", "INT","INT"]
            # },
